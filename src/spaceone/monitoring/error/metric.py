...
class ERROR_NOT_SUPPORT_RESOURCE_TYPE(ERROR_INVALID_ARGUMENT):
    _message = 'Data source not support resource_type. (resource_type = {resource_type})'
...
class ERROR_NOT_FOUND_REQUIRED_KEY(ERROR_INVALID_ARGUMENT):
    _message = 'Required key not found in plugin metadata. (data_source_id = {data_source_id})'
