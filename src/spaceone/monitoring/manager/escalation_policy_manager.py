...
class EscalationPolicyManager(BaseManager):
    ...
    def update_escalation_policy(self, params):
        escalation_policy_vo: EscalationPolicy = self.get_escalation_policy(
            params["escalation_policy_id"], params["domain_id"]
        )
    ...
    def update_escalation_policy_by_vo(self, params, escalation_policy_vo):
        ...
        cache.delete(
            f"escalation-policy-condition:{updated_vo.domain_id}:{updated_vo.escalation_policy_id}"
        )
    ...
    def set_default_escalation_policy(self, params, escalation_policy_vo):
        global_escalation_policy_vos = self.escalation_policy_model.filter(
            domain_id=params["domain_id"], scope="DOMAIN"
        )
    ...
    def get_default_escalation_policy(self, domain_id):
        escalation_policy_vos = self.escalation_policy_model.filter(
            is_default=True, domain_id=domain_id
        )
    ...
    def get_escalation_policy(self, escalation_policy_id, domain_id, only=None):
        return self.escalation_policy_model.get(
            escalation_policy_id=escalation_policy_id, domain_id=domain_id, only=only
        )
