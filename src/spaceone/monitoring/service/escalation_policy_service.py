...
class EscalationPolicyService(BaseService):
    ...
    def get(self, params):
        ...
        return self.escalation_policy_mgr.get_escalation_policy(
            params["escalation_policy_id"], params["domain_id"], params.get("only")
        )
