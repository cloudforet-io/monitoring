...
class TestAlertService(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.transaction = Transaction({"service": "monitoring", "api_class": "Alert"})
        super().setUpClass()
    ...
    @patch.object(
        ...
        "list_events",
        return_value=[
            Event(event_id="event-1130a81e7b64", alert_id="alert-400c20b10a5c"),
            Event(event_id="event-1130a81e7b64"),
        ],
    )
    @patch.object(
        EventManager,
        "update_event_by_vo",
        return_value=Event(
            event_id="event-09729273f6c1",
            alert_id="alert-b02c18c373ae",
            event_type="ALERT",
        ),
    )
    ...
    def test_merge_alerts(self, *args):
        ...
        params = {"merge_to": merge_to, "alerts": alerts, "domain_id": self.domain_id}
        ...
        updated_event = event_mgr.update_event_by_vo(
            self, params=update_event_params, event_vo=event_vo
        )
