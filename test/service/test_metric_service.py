...
class TestMetricService(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.transaction = Transaction({"service": "monitoring", "api_class": "Metric"})
        super().setUpClass()
    ...
    @patch.object(
        DataSourcePluginManager,
        "get_data_source_plugin_endpoint_by_vo",
        return_value="grpc://plugin.spaceone.dev:50051",
    )
    ...
    def test_list_metrics(
        self, mock_list_cloud_services, mock_list_secrets, mock_list_metrics, *args
    ):
        ...
        mock_list_secrets.return_value = {
            "results": [
                {"secret_id": utils.generate_id("secret"), "schema": "aws_access_key"}
            ],
            "total_count": 1,
        }
        ...
        mock_list_cloud_services.return_value = [
            ...
            },
            {
                ...
                "region_code": "ap-northeast-2",
                "reference": {
                    "resource_id": "arn:aws:ec2:ap-northeast-2:123456789012:instance/i-4567"
                },
                "collection_info": {"secret_id": [utils.generate_id("secret")]},
            },
        ]
    ...
    def test_get_metric_data(
        self, mock_list_cloud_services, mock_list_secrets, mock_get_metric_data, *args
    ):
        cs_id_1 = utils.generate_id("cloud_service")
        cs_id_2 = utils.generate_id("cloud_service")
        cs_id_3 = utils.generate_id("cloud_service")
